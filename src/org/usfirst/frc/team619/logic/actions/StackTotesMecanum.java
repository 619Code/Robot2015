...
public class StackTotesMecanum extends Action{
	...
	public StackTotesMecanum(int waitForDependenciesPeriod, int runPeriod, ThreadManager threadManager, SRXMecanumDriveBase driveBase, Flapper flapper, SensorBase sensorBase) {
