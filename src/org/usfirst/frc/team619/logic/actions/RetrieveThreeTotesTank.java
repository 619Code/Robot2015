...
public class RetrieveThreeTotesTank extends Action{

	public RetrieveThreeTotesTank(int waitForDependenciesPeriod, int runPeriod, ThreadManager threadManager, SRXDriveBase driveBase, Flapper flapper, SensorBase sensorBase) {
