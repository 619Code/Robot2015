...
public class RetrieveThreeCansMecanum extends Action{
	...
	public RetrieveThreeCansMecanum(int waitForDependenciesPeriod, int runPeriod, ThreadManager threadManager, SRXMecanumDriveBase driveBase, Flapper flapper, SensorBase sensorBase) {
