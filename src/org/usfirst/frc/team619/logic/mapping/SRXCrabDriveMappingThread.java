 ...
 * @author caadmin
 */
public class SRXCrabDriveMappingThread extends RobotThread {
	protected SRXMecanumDriveBase mecanumDriveBase;
   ...
   // Talon topLefttalon, topRighttalon, bottomLefttalon, bottomRighttalon;
    ...
    public SRXCrabDriveMappingThread(SRXMecanumDriveBase mecanumDriveBase,
